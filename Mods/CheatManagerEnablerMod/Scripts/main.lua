RegisterHook("/Script/Engine.PlayerController:ClientRestart", function(self, NewPawn)
    ...
    print("[CheatManager Creator]"..tostring(PlayerController:IsValid()))
    print("[CheatManager Creator]"..tostring(PlayerController:IsAnyClass()))
    print("[CheatManager Creator]"..tostring(type(PlayerController)))
