...
---@class ABP_BuildObject_WeaponFactory_Dirty_02_C : APalBuildObject
...
ABP_BuildObject_WeaponFactory_Dirty_02_C = {}

function ABP_BuildObject_WeaponFactory_Dirty_02_C:OnAvailable_BlueprintImpl() end
---@param Model UPalMapObjectConcreteModelBase
function ABP_BuildObject_WeaponFactory_Dirty_02_C:OnSetConcreteModel(Model) end
---@param EntryPoint int32
function ABP_BuildObject_WeaponFactory_Dirty_02_C:ExecuteUbergraph_BP_BuildObject_WeaponFactory_Dirty_02(EntryPoint) end
